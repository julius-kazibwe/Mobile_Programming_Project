...
import com.mmproject.taskmanagementapplication.data.WeatherDataSource
import com.mmproject.taskmanagementapplication.data.LocationDataSource
...
class HomeViewModel() : ViewModel() {
    ...
    fun getUserLocation(lat: Double, long: Double){
        com.mmproject.taskmanagementapplication.data.LocationDataSource.getLocation(lat, long) { locationData ->
